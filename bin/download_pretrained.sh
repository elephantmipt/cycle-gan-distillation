# copied from here https://github.com/junyanz/CycleGAN/blob/master/pretrained_models/download_model.sh
# official cycle gan repo. I used it only for model initialization. All training pipeline is mine.
